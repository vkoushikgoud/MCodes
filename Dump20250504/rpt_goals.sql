...
CREATE TABLE `goals` (
  ...
  `TargetSavings` int NOT NULL,
  `MonthlyContribution` int NOT NULL,
  `CurrentSavings` int NOT NULL,
  PRIMARY KEY (`GoalId`),
  KEY `ProfileId_idx` (`ProfileId`),
  CONSTRAINT `ProfileId` FOREIGN KEY (`ProfileId`) REFERENCES `profiles` (`ProfileId`)
...
INSERT INTO `goals` VALUES (1,1,11,55,400000,1900,70000);
